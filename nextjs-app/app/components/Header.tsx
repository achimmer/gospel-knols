    ...
    <header className="fixed z-50 h-24 inset-0 bg-white/80 flex items-center backdrop-blur-lg">
      <div className="container py-6 sm:px-6">
        <div className="flex items-center justify-between gap-5">
          <Link className="flex items-center gap-2 hover:text-sky-600" href="/">
            <svg className="fill-current text-zinc-800 h-5 sm:h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
